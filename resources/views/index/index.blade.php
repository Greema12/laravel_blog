            ...
            <div class="row">
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-danger card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h3 class="font-weight-normal mb-3"><a  title="{{ $liveEvent }} Live Event" href="#"></a>Live Event<i class="mdi mdi-chart-line mdi-24px float-right"></i>
                    </h3>
                    <h3>{{ $liveEvent }}</h3>
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-info card-img-holder text-white">
                  <div class="card-body">
                    <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h3 class="font-weight-normal mb-3">Completed Event <i class="mdi mdi-bookmark-outline mdi-24px float-right"></i>
                    </h3>
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-success card-img-holder text-white">
                  <div class="card-body">
                    <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h3 class="font-weight-normal mb-3">Live Player <i class="mdi mdi-diamond mdi-24px float-right"></i>
                    </h3>
